...
class E_GCL(nn.Module):
    ...
    def coord_model(self, coord, edge_index, coord_diff, edge_attr, lig_mask):
        row, col = edge_index
        coord_weights = self.coord_mlp(edge_attr)
    ...
    def forward(self, h, edge_index, coord, edge_attr=None, node_attr=None, lig_mask=None):
        row, col = edge_index
